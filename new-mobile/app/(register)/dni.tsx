	...
	return (
		<View style={styles.container}>
			...
			<View style={{ width: "80%", marginBottom: 24 }}>
				<Text style={{ fontSize: 18 }}>Necesitamos que suba una fotografía de su cédula de identidad por ambos lados.</Text>
			</View>

			<View style={styles.imageButtonContainer}>
				<Button variant="primary" text={dni_a ? "Volver a tomar" : "Subir lado frontal"} onPress={() => openCamera("dni_a")} size="80%" />
				{!dni_a && <FontAwesome name="square-o" color={errors["dni_a"] ? "red" : primaryGreen} style={styles.checkIcon} />}
			...
			<View style={[styles.imageButtonContainer, { marginBottom: 15 }]}>
				<Button variant="primary" text={dni_b ? "Volver a tomar" : "Subir lado trasero"} onPress={() => openCamera("dni_b")} size="80%" />
				{!dni_b && <FontAwesome name="square-o" color={errors["dni_b"] ? "red" : primaryGreen} style={styles.checkIcon} />}
