...
const Social = ({ navigation, route }: { navigation: any, route: any }) => {
    const { control, setValue, formState: { errors }, getValues, trigger, handleSubmit } = useFormContext()
                ...
                <View>
                    ...
                    {errors["social"] && (
                        <Text style={{ color: "red", alignSelf: "center" }}>
                            {typeof errors["social"].message === "string" ? errors["social"].message : "Error en el campo DNI A"}
                        </Text>
                    )}
