...
import { professionalSelect } from "../utils/filters"
...
export class ProfessionalController {
	...
	public getMany: Controller = async (req, res, handleError) => {
		try {
			const query = ProfessionalSchemas.query.parse(req.query)
			const select = query.select ?? ProfessionalSchemas.defaultSelect
